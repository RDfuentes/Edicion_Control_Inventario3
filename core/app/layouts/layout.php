    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="./" class="logo">
          ...
          <span class="logo-lg"><b>NEW</b>SOFT</span>
        </a>
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                ...
                <li><a href="./?view=res">Historial Abastecimientos</a></li>
              </ul>
            </li>
                        <li class="treeview">
            ...
            <li class="treeview">
              <a href="./?view=users"><i class='fa fa-cog'></i> <span>Usuarios</span> <i class="fa fa-angle-left pull-right"></i></a>
            </li>
          <?php endif;?>
