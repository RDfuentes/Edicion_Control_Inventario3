...
<tr >
	...
	<td><?php echo $product->name; ?></td>
	<td><b>Q. <?php echo number_format($product->price_out); ?></b></td>
	<td><b>Q. <?php  $pt = $product->price_out*$p["q"]; $total +=$pt; echo number_format($pt); ?></b></td>
...
<tr>
	<td><p>Subtotal</p></td>
	<td><p><b>Q. <?php echo number_format($total*.84); ?></b></p></td>
</tr>
<tr>
	<td><p>IVA</p></td>
	<td><p><b>Q. <?php echo number_format($total*.16); ?></b></p></td>
</tr>
<tr>
	<td><p>Total</p></td>
	<td><p><b>Q. <?php echo number_format($total); ?></b></p></td>
</tr>
...
<div class="form-group">
    <div class="col-lg-offset-2 col-lg-10">
      <div class="checkbox">
        ...
        <button class="btn btn-lg btn-primary">Finalizar Venta</button>
        </label>
      </div>
    </div>
  </div>
